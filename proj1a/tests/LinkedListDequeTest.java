...
//     }
    ...
    public void testGet() {
        ...
        assertThat(lld1.get(3) == 2).isTrue();
        assertThat(lld1.get(1) == 1).isTrue();
        assertThat(lld1.get(0) == 10).isTrue();
    }
    ...
    public void testGetVary() {
        ...
        assertThat(lld1.get(0) == 10).isTrue();
        assertThat(lld1.get(3) == 56).isTrue();
    ...
    @Test
    public void testReGetNull() {
        Deque<Integer> lld1 = new LinkedListDeque<>();
        assertThat(lld1.getRecursive(1)).isNull();
    }

    @Test
    public void tesReGetOut() {
        Deque<Integer> lld1 = new LinkedListDeque<>();
    ...
    public void testReGet() {
        ...
        assertThat(lld1.getRecursive(3) == 2).isTrue();
        assertThat(lld1.getRecursive(1) == 1).isTrue();
        assertThat(lld1.getRecursive(0) == 10).isTrue();
    }

    public void testReGetVary() {
        Deque<Integer> lld1 = new LinkedListDeque<>();
        ...
        assertThat(lld1.getRecursive(0) == 10).isTrue();
        assertThat(lld1.getRecursive(3) == 56).isTrue();
